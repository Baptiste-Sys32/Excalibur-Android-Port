...
export function DrawMainMenu(props: DrawMainMenuProps) {
  ...
  return (
    <MainMenu>
      ...
      <MainMenu.Sub>
        <MainMenu.Sub.Trigger>Canvases</MainMenu.Sub.Trigger>
        <MainMenu.Sub.Content>
          <MainMenu.ItemCustom>
            <button className={menuButtonClassName} type="button" onClick={props.openCanvas}>
              <span className="draw-menu-button-label">My canvases</span>
            </button>
          </MainMenu.ItemCustom>
          <MainMenu.ItemCustom>
          ...
          <MainMenu.ItemCustom>
            ...
            >
              <span className="draw-menu-button-label">Recover unsaved work</span>
      ...
      <MainMenu.Sub>
        <MainMenu.Sub.Trigger>Import &amp; share</MainMenu.Sub.Trigger>
        <MainMenu.Sub.Content>
          <MainMenu.ItemCustom>
          ...
          <MainMenu.ItemCustom>
            <button className={menuButtonClassName} type="button" onClick={props.openDirectory}>
              <span className="draw-menu-button-label">Reveal Excalidraw folder</span>
            </button>
          </MainMenu.ItemCustom>
          <MainMenu.ItemCustom>
            <button className={menuButtonClassName} type="button" onClick={props.saveSceneCopy}>
              <span className="draw-menu-button-label">Save scene copy</span>
            </button>
          </MainMenu.ItemCustom>
          <MainMenu.ItemCustom>
      ...
      <MainMenu.Sub>
        <MainMenu.Sub.Trigger>Export</MainMenu.Sub.Trigger>
        <MainMenu.Sub.Content>
          <MainMenu.ItemCustom>
      ...
      <MainMenu.Sub>
        <MainMenu.Sub.Trigger>Page</MainMenu.Sub.Trigger>
        <MainMenu.Sub.Content>
          <MainMenu.ItemCustom>
            <button
              className={menuButtonClassName}
          ...
          <MainMenu.ItemCustom>
            <button className={menuButtonClassName} type="button" onClick={props.toggleGridMode}>
              <span className="draw-menu-button-label">Grid</span>
          ...
          <MainMenu.ItemCustom>
            <button className={menuButtonClassName} type="button" onClick={props.toggleSnapMode}>
              <span className="draw-menu-button-label">Snap to objects</span>
              <span className="draw-menu-badge">
      ...
      <MainMenu.Sub>
        <MainMenu.Sub.Trigger>Pen &amp; touch</MainMenu.Sub.Trigger>
        <MainMenu.Sub.Content>
          <MainMenu.ItemCustom>
            <button
              className={menuButtonClassName}
          ...
          <MainMenu.ItemCustom>
            ...
            >
              <span className="draw-menu-button-label">Advanced · native stylus bridge</span>
              <span className="draw-menu-badge">
